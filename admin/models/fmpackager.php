...
class FMPackagerModelFMPackager extends JModelLegacy
{
    ...
    public function build()
    {
        ...
        $this->tmpZipFile = JPATH_SITE.'/tmp/fmpackager.zip';
        $this->tmpEmptyFile = JPATH_SITE.'/tmp/fmpackager.tmp';
        @unlink($this->tmpZipFile); // Si export précédent
        touch($this->tmpZipFile);
        touch($this->tmpEmptyFile);
    ...
    /**
     * Ajoute les dossiers / fichiers media déclarés dans le XML
     *
     * @param XMLElement $data - Le document XML manifest
     *
     * @return boolean - Médias ajoutés
     */
